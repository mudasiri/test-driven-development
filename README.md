...
This repository includes files for a methods created using Ruby as well as test files for Rspec
...
**[tdd]** In this project includes files for a methods created using Ruby as well as test files for Rspec
...
```sh
  cd my-folder
  git clone git@github.com:mudasiri/test-driven-development.git
```
...
Feel free to check the [issues page](https://github.com/mudasiri/test-driven-development/issues).
